...
The original evidence architecture remains in an appendix. The reference-ETo appendix keeps one feasibility case; spatial diagnostics remain in the source archive.
...
The package is not submitted. The clean source archive compiles locally and passes the repository verifier. arXiv server-side processing remains untested.
